...
// Edit a review and update shop's average rating
exports.editReview = async (req, res) => {
  try {
    ...
    // Check if the user is the owner of the review (admins can't edit other users' reviews)
    if (review.userId.toString() !== req.user._id.toString()) {
      return res.status(403).json({ message: 'Access denied. You can only edit your own reviews.' });
    }
    ...
    review.date = Date.now(); // Update the date to reflect the edit
